const translations = {
    ...
    faq: {
      ...
      q1: {
        ...
        a: "You can start with any amount — even $100. Consistency and strategy matter more than the first deposit size.",
      },
      q2: {
        q: "Do I need special knowledge?",
        a: "No. I explain everything in simple terms and give step-by-step instructions anyone can follow.",
      },
      q3: {
        q: "How long does it take?",
        a: "Consultation — 1-2 hours. Financial plan — 2-3 weeks. Mentorship — from 3 months.",
      },
      q4: {
        q: "Do you guarantee returns?",
        a: "No — and no one can honestly guarantee. I guarantee a systematic approach and transparency.",
      },
      q5: {
        q: "Do you work remotely?",
        a: "Yes, 100% online — Zoom, Telegram, Google Docs. Geography doesn't matter.",
      },
    },
    video: {
      tag: "Education",
    ...
    process: {
      ...
      step3Title: "Strategy",
      step3Desc: "Personal action plan. Support and adjustments.",
    },
    certs: {
      tag: "Qualifications",
  ...
  ua: {
    ...
    faq: {
      title: "Часті питання",
      q1: {
        q: "З якої суми можна почати?",
        a: "Почати можна з будь-якої суми. Важливіше регулярність та стратегія.",
      },
      q2: {
        q: "Чи потрібні спеціальні знання?",
        a: "Ні. Я пояснюю все простою мовою.",
      },
      q3: {
        q: "Як довго триває робота?",
        a: "Консультація — 1-2 години. Фінансовий план — 2-3 тижні.",
      },
      q4: {
        q: "Чи гарантуєте ви дохідність?",
        a: "Ні — і ніхто не може чесно гарантувати.",
      },
      q5: { q: "Чи працюєте ви віддалено?", a: "Так, 100% онлайн." },
    },
    video: {
      tag: "Освіта",
    ...
    process: {
      ...
      step3Title: "Стратегія",
      step3Desc: "Персональний план дій. Супровід та коригування.",
    },
    certs: {
      tag: "Кваліфікація",
  ...
  ru: {
    ...
    faq: {
      ...
      q1: {
        q: "С какой суммы можно начать?",
        a: "Начать можно с любой суммы — даже $100. Важнее регулярность и стратегия, а не размер первого взноса.",
      },
      q2: {
        q: "Нужны ли специальные знания?",
        a: "Нет. Я объясняю всё простым языком и даю пошаговые инструкции, которые сможет выполнить любой.",
      },
      q3: {
        q: "Как долго длится работа?",
        a: "Консультация — 1-2 часа. Финансовый план — 2-3 недели. Менторство — от 3 месяцев.",
      },
      q4: {
        q: "Гарантируете ли вы доходность?",
        a: "Нет — и никто не может честно гарантировать. Я гарантирую системный подход и прозрачность.",
      },
      q5: {
        q: "Работаете ли вы удалённо?",
        a: "Да, 100% работы онлайн — Zoom, Telegram, Google Docs. География не имеет значения.",
      },
    },
    video: {
      tag: "Образование",
    ...
    process: {
      ...
      step3Desc: "Персональный план действий. Сопровождение и корректировки.",
    },
    certs: {
      tag: "Квалификация",
  ...
  es: {
    ...
    faq: {
      ...
      q1: {
        q: "¿Cuál es la cantidad mínima para empezar?",
        a: "Puedes empezar con cualquier cantidad. La consistencia y estrategia importan más.",
      },
      q2: {
        q: "¿Necesito conocimientos especiales?",
        a: "No. Explico todo en términos simples.",
      },
      q3: {
        q: "¿Cuánto tiempo lleva?",
        a: "Consulta — 1-2 horas. Plan financiero — 2-3 semanas.",
      },
      q4: {
        q: "¿Garantiza rendimientos?",
        a: "No — y nadie puede garantizarlo honestamente.",
      },
      q5: { q: "¿Trabaja de forma remota?", a: "Sí, 100% online." },
    },
    video: {
      tag: "Educación",
    ...
    process: {
      ...
      step3Title: "Estrategia",
      step3Desc: "Plan de acción personal. Acompañamiento y ajustes.",
    },
    certs: {
      tag: "Calificaciones",
